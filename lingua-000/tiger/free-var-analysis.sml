structure FreeVarAnalysis :> FREE_VAR_ANALYSIS =
struct
  structure L = List
  ...
  fun analyseVar var = varFrees var Symbol.empty Symbol.empty
  fun analyseExp exp = expFrees exp Symbol.empty Symbol.empty
  fun analyseDec dec = #2 (decFrees dec Symbol.empty Symbol.empty)
end
